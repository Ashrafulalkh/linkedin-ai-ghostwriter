#!/bin/bash
# ==============================================================================
# Hostinger VPS Automated Deployment Script for LinkedIn AI Ghostwriter
# ==============================================================================
...
echo "======================================================="
echo "🚀 Deploying LinkedIn AI Ghostwriter on Hostinger VPS..."
echo "======================================================="

APP_DIR="/var/www/ghostwriter"

# 1. Update system packages
echo "📦 Installing system dependencies (Python 3, pip, venv, curl, git)..."
apt-get update -y
...
echo "  - Check Status:  systemctl status ghostwriter"
echo "  - Restart App:   systemctl restart ghostwriter"
echo "  - View Logs:     journalctl -u ghostwriter -f"
echo "======================================================="
